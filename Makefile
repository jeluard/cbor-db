...
BENCH_WARM_UP_MS ?= 500
BENCH_MEASUREMENT_MS ?= 2000
BENCH_RESAMPLES ?= 20000
ARGS ?=
...
bench: ## &build Run backend benchmarks and refresh benchmark docs
	...
	CBOR_DB_BENCH_SAMPLE_SIZE="$(BENCH_SAMPLE_SIZE)" \
	CBOR_DB_BENCH_WARM_UP_MS="$(BENCH_WARM_UP_MS)" \
	CBOR_DB_BENCH_MEASUREMENT_MS="$(BENCH_MEASUREMENT_MS)" \
	CBOR_DB_BENCH_RESAMPLES="$(BENCH_RESAMPLES)" \
